  ...
  const scenarios = [
    {
      ...
      explanation: "سارة لا تعلم أن أحمد نقل القلم، لذا ستبحث حيث تركته.",
      ageGroup: "4-6 سنوات",
      scenario: "🧒👧📦📝"
    },
    {
    ...
    },
    {
      ...
      question: "أي نوع آيس كريم ستشتري الأم لمريم؟",
      options: ["فراولة", "شوكولاتة", "فانيليا", "لن تشتري لها"],
      correctAnswer: "شوكولاتة",
      explanation: "فهم أن الأشخاص المختلفي�� لديهم تفضيلات مختلفة.",
      ageGroup: "3-5 سنوات",
      scenario: "🍦🍓🍫👧👱‍♀️"
    },
    {
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-700 leading-relaxed">
              نظرية العقل هي القدرة على فهم أن الآخرين لديهم أفكار ومشاعر ومعتقدات قد تختلف عن أفكار��ا ومشاعرنا الخاصة. 
