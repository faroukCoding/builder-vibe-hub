    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/attention-exercises" element={
            <ProtectedRoute>
              <AttentionExercises />
            </ProtectedRoute>
          } />
          ...
          <Route path="/theory-of-mind" element={
            <ProtectedRoute>
              <TheoryOfMind />
            </ProtectedRoute>
          } />
          <Route path="/theory-of-mind-games" element={
            <ProtectedRoute>
              <TheoryOfMindGames />
            </ProtectedRoute>
          } />
          <Route path="/diagnostic-response-sheet" element={
            <ProtectedRoute>
          ...
          <Route path="/portage-report" element={
            <ProtectedRoute>
              <PortageReport />
            </ProtectedRoute>
          } />
          ...
          <Route path="/orthophonic-balance" element={
            <ProtectedRoute>
              <PatientForm />
            </ProtectedRoute>
          } />
          <Route path="/pre-basic-acquisitions" element={
            <ProtectedRoute>
              <PreBasicAcquisitions />
            </ProtectedRoute>
          } />
          <Route path="/implicit-group" element={
            <ProtectedRoute>
              <ImplicitGroup />
            </ProtectedRoute>
          } />
          <Route path="/perceptual-exercises" element={
            <ProtectedRoute>
              <PerceptualExercises />
            </ProtectedRoute>
          } />
          <Route path="/memory-exercises" element={
            <ProtectedRoute>
              <MemoryExercises />
            </ProtectedRoute>
          } />
